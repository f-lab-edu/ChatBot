...
//         }
        ...
        stage('Connect Deploy Server') {
            steps {
                ...
                def previousPid = null
                $previousPid = 'ps -ef | grep java | grep build/fire_inform-0.0.1-SNAPSHOT.jar | grep -v nohup | awk "{print $2}"'
                sh "echo '(sh)previousPid : '$previousPid"
                echo "(echo)previousPid : " + $previousPid
