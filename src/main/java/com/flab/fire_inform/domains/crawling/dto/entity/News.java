...
public class News {
    ...
    public static NewsBuilder builder(String site, String domain, String title, String link,
        String newsTotalUrl) {
    ...
    public static class NewsBuilder {
        ...
        public NewsBuilder(String site, String domain, String title, String link,
            String newsTotalUrl) {
            this.site = site;
            this.domain = domain;
            this.title = title;
