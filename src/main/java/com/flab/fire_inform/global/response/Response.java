...
public class Response<T> {
     ...
     */
    public static <T> ResponseEntity<Response> toResponseEntitySuccess(int code, String message,
        T data) {
    ...
    public static ResponseEntity<Response> toResponseEntityError(ErrorCode errorCode) {
        return ResponseEntity.status(errorCode.getHttpStatus())
            .body(new Response.Builder(errorCode.getHttpStatus().value(),
                errorCode.getDetail()).build());
    }
}
