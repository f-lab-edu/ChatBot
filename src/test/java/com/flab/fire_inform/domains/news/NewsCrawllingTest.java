...
public class NewsCrawllingTest {
   ...
   /* public NewsCrawllingTest(NewsCrawlling newsCrawlling){
    ...
    void testBuilder() {
        ...
        Response<Testt> test = new Response.Builder<Testt>(200, "this is message").data(smalltest)
            .build();
        Response<Testt> test2 = new Response.Builder<Testt>(500, "Server Error").data(smalltest)
            .build();
