...
public class NewsMapperTest {
    ...
    void makeNewsEntity() {
        News news = News.builder("NAVER", "FINANCE", "LG전자 주식이 200% 올랐습니다.",
                "http://www.test.com?newsNumber = 0", "www.test.com")
            .build();
        System.out.println("news = " + news);
        News news2 = News.builder("NAVER", "FINANCE", "LG전자 주식이 200% 올랐습니다.",
                "http://www.test.com?newsNumber = 0", "www.test.com")
    ...
    void getNewsListFromDBUnit() {
        ...
        // 단위 테스트 목적
        News news = News.builder("NAVER", "FINANCE", "메인 본문", "http://www.test.com",
        ...
        for (News oneNews : news2) {
            assertThat(oneNews.getNewsTotalUrl()).isEqualTo(
                "https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=101");
        }
    }
